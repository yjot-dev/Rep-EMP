...
import com.yjotdev.empprimaria.mvvm.model.UserModel
import com.yjotdev.empprimaria.application.theme.EmprendimientoPrimariaTheme
import com.yjotdev.empprimaria.mvvm.view.LoginView
import com.yjotdev.empprimaria.mvvm.view.MenuView
import com.yjotdev.empprimaria.mvvm.view.RecoverKeyView
import com.yjotdev.empprimaria.mvvm.view.RegisterView
import com.yjotdev.empprimaria.mvvm.viewmodel.ProgressViewModel
import com.yjotdev.empprimaria.mvvm.viewmodel.UserController
            ...
            composable(route = ViewRoutes.RecoverKey.name) {
                RecoverKeyView(
                    ...
                    onChangePassword = { email, password ->
                        userController.changePassword(context, email, password)
                    },
                    onSendCode = { email, code ->
                        onCode(code)
                        userController.sendCodeByEmail(context, email, "Usuario", code)
                    }
                )
            }
