    ...
    Row(
        ...
        IconButton(
            ...
            colors = IconButtonDefaults.iconButtonColors(
                containerColor = if(selector == 0) MaterialTheme.colorScheme.inversePrimary
        ...
        IconButton(
            onClick = clickEducationalModules,
            colors = IconButtonDefaults.iconButtonColors(
                containerColor = if(selector == 1) MaterialTheme.colorScheme.inversePrimary
                                 else Color.Unspecified
            ),
            modifier = Modifier.size(dimensionResource(id = R.dimen.dm_5))
        ) {
        ...
        IconButton(
            onClick = clickPracticalProjects,
            colors = IconButtonDefaults.iconButtonColors(
                containerColor = if(selector == 2) MaterialTheme.colorScheme.inversePrimary
                                 else Color.Unspecified
            ),
            modifier = Modifier.size(dimensionResource(id = R.dimen.dm_5))
        ) {
        ...
        IconButton(
            onClick = clickTrackingAndSupport,
            colors = IconButtonDefaults.iconButtonColors(
                containerColor = if(selector == 3) MaterialTheme.colorScheme.inversePrimary
                                 else Color.Unspecified
            ),
            modifier = Modifier.size(dimensionResource(id = R.dimen.dm_5))
        ) {
